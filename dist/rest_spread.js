...
function somarComRest() {
  ...
  //Aqui só funciona com argumentos fixos.
  var soma = numero.reduce(function (total, numeroAtual) {
    total += numeroAtual;
    return total;
  }, 0);
  return soma;
...
var timesDeFutebolDeRi = ['vasco', 'botafogo', 'flamengo', 'fluminense'];

//const timesDeFutebol = timesDeFutebolDeSp.concat(timesDeFutebolDeRi)
var timesDeFutebol = [].concat(timesDeFutebolDeSp, timesDeFutebolDeRi); //Aqui pega o restante do conteudo
...
var motrDoCarroDaAna = carroDaAna.motor;
var motrDoCarroDaJulia = carroDaJulia.motor;
...
var _timesDeFutebol = _toArray(timesDeFutebol),
  ...
  outrosTimes = _timesDeFutebol.slice(3); //Aqui o ... pega o restante do conteudo
